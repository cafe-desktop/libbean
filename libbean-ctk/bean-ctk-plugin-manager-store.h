...
#ifndef __BEAN_CTK_PLUGIN_MANAGER_STORE_H__
#define __BEAN_CTK_PLUGIN_MANAGER_STORE_H__
...
typedef enum {
  BEAN_CTK_PLUGIN_MANAGER_STORE_ENABLED_COLUMN = 0,
  BEAN_CTK_PLUGIN_MANAGER_STORE_CAN_ENABLE_COLUMN,
  BEAN_CTK_PLUGIN_MANAGER_STORE_ICON_GICON_COLUMN,
  BEAN_CTK_PLUGIN_MANAGER_STORE_ICON_STOCK_ID_COLUMN,
  BEAN_CTK_PLUGIN_MANAGER_STORE_ICON_VISIBLE_COLUMN,
  BEAN_CTK_PLUGIN_MANAGER_STORE_INFO_COLUMN,
  BEAN_CTK_PLUGIN_MANAGER_STORE_INFO_SENSITIVE_COLUMN,
 ...
 */
#define BEAN_CTK_TYPE_PLUGIN_MANAGER_STORE            (bean_ctk_plugin_manager_store_get_type())
#define BEAN_CTK_PLUGIN_MANAGER_STORE(obj)            (G_TYPE_CHECK_INSTANCE_CAST((obj), BEAN_CTK_TYPE_PLUGIN_MANAGER_STORE, BeanCtkPluginManagerStore))
#define BEAN_CTK_PLUGIN_MANAGER_STORE_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST((klass), BEAN_CTK_TYPE_PLUGIN_MANAGER_STORE, BeanCtkPluginManagerStoreClass))
#define BEAN_CTK_IS_PLUGIN_MANAGER_STORE(obj)         (G_TYPE_CHECK_INSTANCE_TYPE((obj), BEAN_CTK_TYPE_PLUGIN_MANAGER_STORE))
#define BEAN_CTK_IS_PLUGIN_MANAGER_STORE_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), BEAN_CTK_TYPE_PLUGIN_MANAGER_STORE))
#define BEAN_CTK_PLUGIN_MANAGER_STORE_GET_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS((obj), BEAN_CTK_TYPE_PLUGIN_MANAGER_STORE, BeanCtkPluginManagerStoreClass))
...
#endif /* __BEAN_CTK_PLUGIN_MANAGER_STORE_H__  */

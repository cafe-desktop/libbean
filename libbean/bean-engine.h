...
PEAS_AVAILABLE_IN_ALL
PeasEngine       *bean_engine_new                 (void);
PEAS_AVAILABLE_IN_ALL
PeasEngine       *bean_engine_new_with_nonglobal_loaders
                                                  (void);
PEAS_AVAILABLE_IN_ALL
PeasEngine       *bean_engine_get_default         (void);

PEAS_AVAILABLE_IN_ALL
void              bean_engine_add_search_path     (PeasEngine      *engine,
                                                   const gchar     *module_dir,
                                                   const gchar     *data_dir);
PEAS_AVAILABLE_IN_ALL
void              bean_engine_prepend_search_path (PeasEngine      *engine,
                                                   const gchar     *module_dir,
                                                   const gchar     *data_dir);

/* plugin management */
PEAS_AVAILABLE_IN_ALL
void              bean_engine_enable_loader       (PeasEngine      *engine,
                                                   const gchar     *loader_name);
PEAS_AVAILABLE_IN_ALL
void              bean_engine_rescan_plugins      (PeasEngine      *engine);
PEAS_AVAILABLE_IN_ALL
const GList      *bean_engine_get_plugin_list     (PeasEngine      *engine);
PEAS_AVAILABLE_IN_ALL
gchar           **bean_engine_get_loaded_plugins  (PeasEngine      *engine);
PEAS_AVAILABLE_IN_ALL
void              bean_engine_set_loaded_plugins  (PeasEngine      *engine,
                                                   const gchar    **plugin_names);
PEAS_AVAILABLE_IN_ALL
PeasPluginInfo   *bean_engine_get_plugin_info     (PeasEngine      *engine,
                                                   const gchar     *plugin_name);

/* plugin loading and unloading */
PEAS_AVAILABLE_IN_ALL
gboolean          bean_engine_load_plugin         (PeasEngine      *engine,
                                                   PeasPluginInfo  *info);
PEAS_AVAILABLE_IN_ALL
gboolean          bean_engine_unload_plugin       (PeasEngine      *engine,
                                                   PeasPluginInfo  *info);
PEAS_AVAILABLE_IN_ALL
void              bean_engine_garbage_collect     (PeasEngine      *engine);

PEAS_AVAILABLE_IN_ALL
gboolean          bean_engine_provides_extension  (PeasEngine      *engine,
                                                   PeasPluginInfo  *info,
...
PEAS_AVAILABLE_IN_ALL
PeasExtension    *bean_engine_create_extensionv   (PeasEngine      *engine,
                                                   PeasPluginInfo  *info,
                                                   GType            extension_type,
                                                   guint            n_parameters,
...
PeasExtension    *bean_engine_create_extension_with_properties
                                                  (PeasEngine     *engine,
                                                   PeasPluginInfo *info,
                                                   GType           extension_type,
                                                   guint           n_properties,
...
PEAS_AVAILABLE_IN_ALL
PeasExtension    *bean_engine_create_extension_valist
                                                  (PeasEngine      *engine,
                                                   PeasPluginInfo  *info,
                                                   GType            extension_type,
                                                   ...
                                                   va_list          var_args);
PEAS_AVAILABLE_IN_ALL
PeasExtension    *bean_engine_create_extension    (PeasEngine      *engine,
                                                   PeasPluginInfo  *info,
                                                   GType            extension_type,
                                                   const gchar     *first_property,
                                                   ...);
